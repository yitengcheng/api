...
##### 52. [司机获取当前运输中的货车信息(uploadLocation)](#52-司机获取当前运输中的货车信息)
##### 53. [司机获取当前运输中的货车信息(confirmReach)](#53-司机获取当前运输中的货车信息)
##### 54. [司机获取当前运输中的货车信息(getLocationList)](#54-司机获取当前运输中的货车信息)
## 路线api
...
---
### 54. [司机获取当前运输中的货车信息](#54-司机获取当前运输中的货车信息getlocationlist)
- `getOnWayTruck`
- 请求方式：`POST`
