...
##### 2. [登录1(login)](#2-登录1)
##### 3. [注册(register)](#3-注册)
##### 4. [发送验证码(requestSendVerifyCode)](#4-发送验证码)
##### 5. [修改支付密码(setPaymentPassword)](#5-修改支付密码)
##### 6. [修改登录密码(findPassword)](#6-修改登录密码)
##### 7. [获取账户余额(getRemainAmount)](#7-获取账户余额)
##### 8. [货主账户充值(recharge)](#8-货主账户充值)
##### 9. [货主账户提现(withdraw)](#9-货主账户提现)
##### 10. [获取个人信息(getPersonalInfo)](#10-获取个人信息)
##### 11. [修改个人信息(modifyPersonalInfo)](#11-修改个人信息)
##### 12. [修改密码(modifyPassword)](#12-修改密码)
...
---
### 4. [发送验证码](#4-发送验证码requestsendverifycode)
...
### 5. [修改支付密码](#5-修改支付密码setpaymentpassword)
- `setPaymentPassword`
- 请求方式：`POST`
...
### 7. [获取账户余额](#7-获取账户余额getremainamount)
- `getRemainAmount`
- 请求方式：`POST`
...
### 10. [获取个人信息](#10-获取个人信息getpersonalinfo)
- `getPersonalInfo`
- 请求方式：`POST`
...
### 11. [修改个人信息](#11-修改个人信息modifypersonalinfo)
- `modifyPersonalInfo`
- 请求方式：`POST`
