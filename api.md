...
## 业务员
##### 120. [获取业务员列表(getSalesmanList)](#120-获取业务员列表)
...
---
### 120. [获取业务员列表](#120-获取业务员列表getsalesmanlist)
- `getSalesmanList`
- 请求方式：`POST`
...
---
### 121. [替换我的业务员](#121-替换我的业务员replacesalesman)
- `replaceSalesman`
- 请求方式：`POST`
...
| :- |:-:| :-:|
| userId | ID | 用户Id |
| oldSalesmanId | ID | 老业务员ID |
| newSalesmanId | ID | 新业务员ID |
...
---
### 122. [主动申请业务员](#122-主动申请业务员applysalesman)
- `applySalesman`
- 请求方式：`POST`
...
---
### 123. [获取业务员详情](#123-获取业务员详情getsalesmandetail)
- `getSalesmanDetail`
- 请求方式：`POST`
...
```js
{
  ...
  "context":{
      ...
      "name":"业务员1"
      "phone":"13712341231"
      "registerTime":"2017-12-13 14:33:41"
      "sex":0
      "starLevel":0
      "suborCount":0
      "suspend":false
